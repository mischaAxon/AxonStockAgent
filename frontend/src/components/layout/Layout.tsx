...
import { LayoutDashboard, Activity, Eye, Grid2x2, Briefcase, Users, Plug, LogOut, Newspaper, SlidersHorizontal } from 'lucide-react';
...
const adminItems = [
  ...
  { to: '/admin/settings',  label: 'Instellingen', icon: SlidersHorizontal },
];
